...
echo '<a class="button" href="' . esc_url(site_url('/create-competition')) . '">Add Competition</a>';
echo '<a class="button" href="' . esc_url(site_url('/view-all-competitions')) . '">View All Competitions</a>';
echo '</div>';
